...
{
    public class RS256JwtAppTests : IClassFixture<JwtAppFactory<RS256TestStartup>>
    {
        private readonly JwtAppFactory<RS256TestStartup> _factory;

        public RS256JwtAppTests(JwtAppFactory<RS256TestStartup> factory)
        {
            _factory = factory;
        }
